        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="/create/artikel" method="post">
                  @csrf
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="/edit/{{$kt->id}}/artikel" method="post">
                  @csrf
                  
                    <div class="form-group">
                    <label for="exampleInputEmail1">Nama artikel</label>
                    <input type="text" class="form-control  @if($errors->has('artikel')) is-invalid   @endif" name="artikel" value="{{$kt->nama_artikel}}" id="exampleInputEmail1" placeholder="Nama artikel">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                           <a href="#" class="btn btn-danger btn-sm delete" nama-produk="{{$kt->nama_artikel}}" produk-id="{{$kt->id}}">Delete</a>
									
                           <button type="button" class="btn  btn-sm btn-warning" data-toggle="modal" data-target="#modal-edit{{$kt->id}}">
                        Edit
                </button>
                <a href="#" class="btn btn-success btn-sm delete">View</a>
...
$('.delete').click(function(){
		  ...
		  swal({
		  title: "Yakin  ?",
		  text: "Mau menghapus data artikel dengan nama " +nama_produk + "??",
		  icon: "warning",
		  buttons: true,
		  dangerMode: true,
		})
